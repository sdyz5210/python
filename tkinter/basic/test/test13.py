...
class Application(Frame):
    ...
    def createWidgets(self):
        self.tb=Notebook(self,height=200,width=300)
    ...
    def func(self,event):
        ...
        if select=='I003' and self.lock2==0:
            ...
            btn1=Button(self.child,text='提交',style='C.TButton',command=self.submit)
            btn2=Button(self.child,text='重置',style='C.TButton',command=self.reset)
