...
def main():
	#linecount = getLineCount(3)
	linecount = 1200
	judgmentValue(linecount)
	stopline = int(linecount)-4
	for i in range(0,stopline,4):
		#读取某一行
		fastqSeqR1 = FastqSeq()
		fastqSeqR1.name = linecache.getline(fileInputR1,i) 
		fastqSeqR1.seq = linecache.getline(fileInputR1,i+1)
		fastqSeqR1.plus = linecache.getline(fileInputR1,i+2)
		fastqSeqR1.seqQ = linecache.getline(fileInputR1,i+3)
		fastqSeqR2 = FastqSeq()
		fastqSeqR2.name = linecache.getline(fileInputR2,i) 
		fastqSeqR2.seq = linecache.getline(fileInputR2,i+1)
		fastqSeqR2.plus = linecache.getline(fileInputR2,i+2)
		fastqSeqR2.seqQ = linecache.getline(fileInputR2,i+3)
		toDo(fastqSeqR1,fastqSeqR2)
